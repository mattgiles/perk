...
test("isPlanGuidanceStage: every read-only registry stage outside plan/objective-plan is owned elsewhere; the stage-less session and a worktree stage are admitted", () => {
