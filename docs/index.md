...
| [design/docs-site-walkthrough-evidence.md](./design/docs-site-walkthrough-evidence.md) | The **executable docs walkthrough evidence record**: the dated disposable-repo credential/Actions preflight and its cleanup proof, plus explicit deferred records for tutorial walkthrough evidence not yet executed. Later walkthrough nodes append their rows here; the final gate consumes the complete record. |
