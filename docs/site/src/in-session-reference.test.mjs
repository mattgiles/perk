...
test("marked borrowed and spawned-child censuses equal their exported authorities", () => {
  ...
  // Waves spawn with the intercom bridge off — no perk child ever holds the supervisor door.
  assert.ok(!children.includes("contact_supervisor"), "child tool census: supervisor retired");
