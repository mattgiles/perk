...
2026-06); the tier contract lives in `shared/contracts.md` §8.24
(+ `perk/backends/objective_store.py`) — the Linear-specific mechanics are here.
...
The #609 design landed (drift engine + worker detail live in `perk/objective/drift.py` +
contracts §8.54).
