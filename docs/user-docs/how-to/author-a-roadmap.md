...
1. **Start authoring.** Run
   [`perk objective-author`](../reference/cli.md#perk-objective-author-alias-oauthor) (alias
   `perk oauthor`). perk launches a read-only session for drafting the objective + roadmap.
