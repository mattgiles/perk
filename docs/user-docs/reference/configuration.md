...
| `draft-reviewer` | string (model id) | _(agent frontmatter default)_ | Model for the draft-reviewer agent (streamed plan/objective draft review; spawned by the draft-review browser doors — landing in a follow-up change). |
