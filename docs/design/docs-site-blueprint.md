...
- Every routed page appears in the sidebar or is explicitly recorded here as a
  non-navigation page. **There are no non-navigation pages: all 71 routed pages appear in
  the sidebar** — Home, the four section landings, and the 66 entries enumerated below
  (70/65 as originally committed; +1 per the §1 corpus amendment of 2026-08-12).
