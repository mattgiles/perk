...
- **Each section label is itself the link to that section's landing page** — Tutorials →
  `/tutorials/`, How-to guides → `/how-to/`, Reference → `/reference/`, Explanation →
  `/explanation/`. The four quadrant landing pages hold position 0 of their sections as
  these section-label links; they are not repeated as child entries.
...
- Every routed page appears in the sidebar or is explicitly recorded here as a
  ...
  routed pages appear in the sidebar** — Home, the four section-label landing links, and
  the 65 entries enumerated below.
