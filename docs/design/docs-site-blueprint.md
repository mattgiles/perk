...
*Amendment (2026-08-20, node 5.2, objective #1892):* the corpus has grown by one file —
`how-to/run-the-learn-dream-factory.md` (the `perk learn dream` whole-corpus curation factory,
Objectives & learnings) — now recorded in the §2 route table, the §3 sidebar map, and the §4
inventory. This amendment also records `how-to/enable-shell-completion.md` (Customization,
added 2026-08-18 by the shell-completion feature without a §1 amendment) in the same three
places. Corpus-wide totals re-derived fresh from the tree: **73** files by the §1 corpus
selector (**77** total sources counting the four `.mdx` pages; `_authoring.md` stays the one
...
| `docs/user-docs/how-to/run-the-learn-dream-factory.md` *(added 2026-08-20)* | `/how-to/run-the-learn-dream-factory/` | How-to › Objectives & learnings |
...
- Every routed page appears in the sidebar or is explicitly recorded here as a
  non-navigation page. **There are no non-navigation pages: all 76 routed pages appear in
  the sidebar** — Home, the four section landings, and the 71 entries enumerated below
  (70/65 as originally committed; +1 per the §1 corpus amendment of 2026-08-12; +3 per the
  §1 amendment of 2026-08-13; +2 per the §1 amendment of 2026-08-20).
...
2. **Objectives & learnings** — author-a-roadmap, replan-an-objective, advance-or-skip-nodes,
   ...
   *run-the-learn-dream-factory* (added 2026-08-20).
...
| `docs/user-docs/how-to/run-the-learn-dream-factory.md` *(added 2026-08-20)* | How-to | keep-and-polish | `/how-to/run-the-learn-dream-factory/` | checklist (satisfied at creation) | 5.2 (obj. #1892) |
...
| 2026-08-13 | Node 3.6 disposable-repo proof | `PERK_ENABLED` absent (default-on); static check healthy; Actions run `31738120479` and job `94574614697` completed with conclusion `success`; zero dispatch record, branch, PR, issue, outcome, or artifact; both secrets, the private repository, and the local clone were removed and absence was proven. [Full sanitized evidence](./docs-site-walkthrough-evidence.md#node-36-remote-runner-walkthrough). |
