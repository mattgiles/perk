...
# context (stages/**, common/** include partials, the commit-and-compact and draft-and-compact
# template families) — raw committed file bytes. Derivation is fixed from the recorded post-diet
# actual, not the current scan:
