...
- **workflow/objective-delivery** — You are touching src/perk/delivery/ (the operation journal, TrainPersistence), delivery_order/validate_stacked_roadmap, a delivery-operation or recovery node, or the stacked-delivery header fields.
