...
- **pi-extension** — Pi SDK/extension substrate craft — API facts, context injection/loading, seams, TUI surfaces, tool-param decode, headless session driving. (pi/context-injection, pi/context-system, pi/extension-api, pi/extension-seams, pi/headless-session-drive, pi/tool-param-decode, pi/tui-surfaces)
