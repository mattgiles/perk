...
- **workflow/session-audit-expectations** — You are curating perk-dev audit expectations (expectations.yaml), writing a session-audit checker, or citing what the read-only gate / skill delivery actually enforces vs intends.
