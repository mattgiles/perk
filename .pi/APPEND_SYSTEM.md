...
- **workflow/provider-seam** — You are working on a provider seam (plan/todo/askuser/footer/web/review) — classifying a candidate seam, wiring or widening a provider, vacating a collision, or the cross-plane resolver.
