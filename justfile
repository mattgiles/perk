...
docs-check:
    uv run pytest tests/test_user_docs_metadata.py tests/test_explanation_boundary.py tests/test_docs_site_tokens.py tests/test_docs_gates.py "tests/test_packaging.py::test_docs_site_publish_isolation" -q
