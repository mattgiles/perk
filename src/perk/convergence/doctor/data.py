...
# Render groups for the managed convergences: settings, the borrowed engine's native worktree
# default + the required-perk-version pin under "package", the workflow-dir/cache layout under
# "state", the rest under "repository".
_MANAGED_GROUP: dict[str, str] = {
    "settings-wiring": "package",
    "subagent-worktree-default": "package",
    "workflow-dir": "state",
