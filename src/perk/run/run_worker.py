...
def _spawn_worker(
    ...
    # FFF mode is behavioral — the additive mode keeps pi's builtin grep/find host-builtins for
    # pi-subagents' host-tool intersection; `_NPM_QUIET_ENV` stays local-only (cosmetic). Same
