...
_ADDRESS_HELP = (
    ...
    "pasted issue URL) — or the plan's PR: its number or pasted .../pull/N URL, resolved to "
    "the plan it records: omit it to address the active saved plan — selected, in order, from an "
