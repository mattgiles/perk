"""Tests for erk land command PR resolution errors by branch.

Tests for error cases when looking up PRs by branch name:
- PR not found by number
- Branch has no PR
- Branch's PR is not open
- Branch's PR targets wrong base
"""
